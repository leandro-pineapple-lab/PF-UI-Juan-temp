...
@Component({
  selector: 'app-pre-d-letter-sent-filters',
  templateUrl: './pre-d-letter-sent-filters.component.html',
  styleUrls: ['./pre-d-letter-sent-filters.component.scss']
})
export class PreDLetterSentFiltersComponent implements OnInit {
  ...
  constructor(private userService: UserService, private advocateService:AdvocateService, private toastr: ToastrService,
